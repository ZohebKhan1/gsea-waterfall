...
| `direction` | Whether the waterfall plot will be used positive or negative NES GO terms. |
...
| `top_n` | Total number of ranked and plotted GO terms after adjusted-p-value and direction filtering. |
...
| Parameter | Practical effect |
| :-- | :-- |
| `padj_threshold` | Keeps terms with `padj < padj_threshold` before plotting; use `NULL` to retain all terms. |
...
| `padj_threshold` | Keeps terms with `padj < padj_threshold` before direction and NES-boundary filtering. |
...
| Parameter | Practical effect |
| :-- | :-- |
| `padj_threshold` | Keeps a shared term when either contrast has `padj < padj_threshold`; use `NULL` to disable this filter. |
